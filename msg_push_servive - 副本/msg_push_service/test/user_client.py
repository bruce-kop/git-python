...
def login():
    hd = get_base_head()
    p={'phone':'15382359899','pwd':'Hik123456'}
    p = json.dumps(p)
    ...
    while True:
        try:
            ...
            if d:
                ...
                print("from:{} /n    {}".format(from_u,msg))
        except TimeoutError:
            pass
        time.sleep(1)
...
if __name__ == '__main__':
    #15382359899 ba0b7df0-a7ca-4a31-93d6-e0bcefc41ddc
    ...
    while True:
        msg = input("我：")
        dg = {"method": "4003",
              "message": {"token": token, "content": msg, "to": "42177ae4-81bf-4bc8-8fc5-74a025cd154f", "g_o_u": 1,
                          "msg_type": "video"}}
        sendmsg(s, dg)
